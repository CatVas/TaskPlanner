...
/******/ 	__webpack_require__.p = "/TaskPlanner/";
/******/
/******/
...
var _Scheduler = _interopRequireDefault(__webpack_require__(29));

var _Spinner = _interopRequireDefault(__webpack_require__(44));

var _Task = _interopRequireDefault(__webpack_require__(49));
...
var _reactHotLoader = __webpack_require__(58);
...
let App = (_dec = (0, _reactHotLoader.hot)(module), _dec(_class = class App extends _react.Component {
  render() {
    return _react.default.createElement(_components.Scheduler, null);
  }
...
class Scheduler extends _react.Component {
  constructor(...args) {
    ...
    _defineProperty(this, "_createTaskAsync", async ev => {
      ev.preventDefault();
      const {
        newTaskMessage
      } = this.state;
    ...
    _defineProperty(this, "_updateNewTaskMessage", ev => {
      this.setState({
        newTaskMessage: ev.target.value
      });
    });
    ...
    _defineProperty(this, "_updateTasksFilter", ev => {
      this.setState({
        tasksFilter: ev.target.value.toLowerCase()
      });
    });
  }
  ...
  render() {
    ...
    }), _react.default.createElement("button", null, "\u0414\u043E\u0431\u0430\u0432\u0438\u0442\u044C \u0437\u0430\u0434\u0430\u0447\u0443")), _react.default.createElement("ul", null, _react.default.createElement(_reactFlipMove.default, {
      duration: 400
    }, tasksToShow.map(task => _react.default.createElement(_components.Task, _extends({
      _removeTaskAsync: this._removeTaskAsync,
      _updateTaskAsync: this._updateTaskAsync,
      key: task.id
    }, task)))))), _react.default.createElement("footer", null, _react.default.createElement(_Checkbox.default, {
...
const headersFull = _objectSpread({}, headers, {
...
_defineProperty(Spinner, "propTypes", _config.PROP_TYPES);

_defineProperty(Spinner, "defaultProps", _config.DEFAULT_PROPS);
...
exports.PROP_TYPES = exports.DEFAULT_PROPS = void 0;
...
const PROP_TYPES = {
  isSpinning: _propTypes.default.bool
};
...
var _Task = _interopRequireDefault(__webpack_require__(50));
...
class Task extends _react.PureComponent {
  constructor(...args) {
    ...
    _defineProperty(this, "_updateTaskMessageOnKeyDown", ev => {
      const {
        newMessage
      } = this.state;
  ...
  render() {
    ...
    }, _react.default.createElement(_assets.Checkbox, {
      inlineBlock: true,
      checked: completed,
    ...
    }, _react.default.createElement(_assets.Star, {
      inlineBlock: true,
      checked: favorite,
    ...
    }), _react.default.createElement(_assets.Edit, {
      inlineBlock: true,
    ...
    }), _react.default.createElement(_assets.Remove, {
      inlineBlock: true,
...
_defineProperty(Task, "propTypes", _config.PROP_TYPES);
...
var _Edit = _interopRequireDefault(__webpack_require__(52));

var _Remove = _interopRequireDefault(__webpack_require__(53));

var _Star = _interopRequireDefault(__webpack_require__(54));
...
const PROP_TYPES = {
  _removeTaskAsync: _propTypes.func,
  _updateTaskAsync: _propTypes.func,
  completed: _propTypes.bool,
  favorite: _propTypes.bool,
